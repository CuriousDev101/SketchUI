...
public class main {
  ...
  public static Button createButton(
      PApplet parent, String label, float x, float y, float w, float h) {
  ...
  // public static Button createButton(PApplet parent, String label, float x,
  // float y, float w,
  // float h, int bgColor, int alignment) {
  // Button button = new Button(parent, label, bgColor, alignment, x, y, w, h);
  // buttons.add(button);
  // return button;
  // }
  ...
  public static TextField createTextField(
      PApplet parent, String label, float x, float y, float w, float h, float r) {
  ...
  public static TextField createTextField(
      PApplet parent, float x, float y, float w, float h, float r) {
    TextField textField = new TextField(parent, x, y, h, r);
    return textField;
  }

  // public static TextField createTextField(PApplet parent, String label, float
  // x, float y,
